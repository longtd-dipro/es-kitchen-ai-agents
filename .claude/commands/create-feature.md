...
Xác nhận feature chưa có đủ SPEC.md + DESIGN.md + tasks/*.md (nếu đã có rồi, hỏi lại user có chắc muốn chạy lại Planning phase không). Gọi tool Workflow `name: "bmad-plan-phase"`, `args: { feature: "<feature>", description: "<mô tả>" }`.
