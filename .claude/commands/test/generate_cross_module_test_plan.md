...
> **Dùng khi:** tính năng đi qua **nhiều modules nối tiếp**, output cuối phụ thuộc **tổ hợp dimensions** (ví dụ: Order với loại company × loại contract × payment method × delivery type).
...
Ưu tiên DOCUMENT cho ESKITCHEN (đã có SPEC chuẩn BMAD).

## Input

| Input | Bắt buộc | Mô tả |
|---|---|---|
| Tên feature / luồng | ✅ | Ví dụ: "Đặt hàng có contract → giao hàng → thanh toán" |
| SPEC.md | ✅ | |
...
`es-kitchen-docs/docs/features/<feature>/test-cases/cross_module_plan.md`
...
dimensions = {
    "D1_company_type": ["Corporate", "SME", "Startup"],
    "D2_contract_type": ["Monthly", "OneTime"],
    "D3_payment": ["elepay", "Alipay", "WeChat"],
}
...
```json
{
  ...
  "dimensions": {"D1": "Corporate", "D2": "Monthly", "D3": "elepay"},
  "supporting_data": {
