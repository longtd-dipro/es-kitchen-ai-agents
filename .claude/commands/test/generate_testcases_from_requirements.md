...
`es-kitchen-docs/docs/features/<feature>/test-cases/tc_<module>.md`
...
- ID format: `ESK_<MODULE>_TC_<NNN>`
- Test Data **cụ thể**: `qc_order_001@eskitchen.test`, không `email hợp lệ`
