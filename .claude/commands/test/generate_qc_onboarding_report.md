...
- QC mới được assign vào dự án ESKITCHEN đang chạy
...
|---|---|---|
| Tên + mô tả ngắn | ✅ | "ESKITCHEN Phase 2 — quản lý bếp doanh nghiệp cho client Nhật" |
| Bộ TC hiện có | ⚠️ | Path `es-kitchen-docs/docs/features/*/test-cases/` |
| SPEC.md đã có | ⚠️ | Path `es-kitchen-docs/docs/features/*/SPEC.md` |
...
`es-kitchen-docs/docs/qc-onboarding/<qc_name>_<date>.md` (hoặc path user chỉ định)
...
```markdown
# QC Onboarding Report — ESKITCHEN
