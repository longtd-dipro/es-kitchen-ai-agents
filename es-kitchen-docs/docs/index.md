...
| 2 | **"Hãy là Tech Lead Design, làm DESIGN.md từ SPEC: `<path>`"** | `DESIGN.md` per repo | `techlead-design-agent` |
...
| 5b | **"Hãy là Frontend Developer, implement task: `<task-X-Y.md>`"** | Working code | `frontend-agent` |
| 5c | **"Hãy là Mobile Developer, implement task: `<task-X-Y.md>`"** | Working code | `mobile-agent` |
| 6 | **"Hãy là QC, sinh test cases từ SPEC: `<path>`"** | Test cases `.md` | `qc-agent` |
| 7 | **"Hãy là QA, verify task: `<task-X-Y.md>`"** | QA Report | `qa-agent` |
...
flowchart TD
    ...
    Branch -->|"'Hãy là Tech Lead Design ...'"| TLD["🟦 techlead-design-agent"]
    Branch -->|"'Hãy là QC, sinh test cases ...'"| QC["🟪 qc-agent"]
    ...
    class SPEC,DESIGN,TASKS,PLAN,CODE,TC,Report,ISSUES artifact;
...
- 🟨 Artifacts (`SPEC.md` · `DESIGN.md` · `tasks/*.md` · `PLAN.md` · code · test cases · QA Report)
...
- **Phân nhánh sau SPEC**: Tech Lead Design (kỹ thuật) chạy song song với QC (test cases) — không cần đợi nhau
